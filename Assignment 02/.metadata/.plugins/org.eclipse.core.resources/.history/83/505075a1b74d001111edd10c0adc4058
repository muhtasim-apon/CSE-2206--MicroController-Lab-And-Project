...
//void convert_angle_to_CCR(uint32_t theta)
//{
//	TIM2->CCR1=0;
//	double time=1000.0f + ((theta)*1000)/180.0f;
//	double CCR=time*90.0f;
//	TIME2->CCR1=CCR;
//}
...
int main(void)
{
	...
	Tim6_Init();
	USART2_INIT();
	USART2_SendString("Target Angle  Pulse Width(us)  CCR VALUE\r\n");
	for(int i=0;i<=180;i+=10)
	{
		...
		// Standard formula with integer rounding (+90 = +range/2)
		        double time = 500.0f + ((i * 2000.f) ) / 180.0;
